...
export class PricingService {
  ...
  createPricing(cotizaciones: Cotizacion[]) { // Servicio para crear cotizaciones
    return this.http.post(`${this.appService.url}cotizador/insertCotizacion`, cotizaciones)
      .pipe(map(res => res));
  }
