...
class CatalogoController extends base_controller_1.BaseController {
    ...
    initRoutes() {
        ...
        this.router.get(`${this.basePath}/tramite/getTramites/:idMarca/:idSucursal`, this.getTramites.bind(this));
    ...
    getTramites(request, response) {
        ...
        tramiteBusiness.getTramites(idMarca, idSucursal).then((tramites) => {
