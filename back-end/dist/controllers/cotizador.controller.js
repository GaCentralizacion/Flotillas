...
class CotizadorController extends base_controller_1.BaseController {
    ...
    initRoutes() {
        ...
        this.router.post(`${this.basePath}/insertCotizacion`, this.insertCotizacion.bind(this));
        ...
        // Cambio P10 - EHJ-COAL
        this.router.get(`${this.basePath}/validaUnidadesFacturadas/:idCotizacion`, this.validaUnidadesFacturadas.bind(this));
        // Cambio P10 - EHJ-COAL
    ...
    insertCotizacion(request, response) {
        ...
        cotizacionBussines.insertCotizacion(data).then((res) => {
    ...
    // Cambio P07 - EHJ-COAL
    validaUnidadesFacturadas(request, response) {
        const idCotizacion = request.params.idCotizacion;
        const cotizacionBusiness = new cotizador_1.CotizadorBussiness();
        cotizacionBusiness.validaUnidadesFacturadas(idCotizacion)
            .then((res) => {
            response.status(200).json(res);
        })
            .catch((error) => {
