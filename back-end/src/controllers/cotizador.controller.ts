...
export class CotizadorController extends BaseController implements IController {
    ...
    initRoutes() {
        ...
        this.router.post(
            `${this.basePath}/insertCotizacion`, this.insertCotizacion.bind(this),
        );
        this.router.get(
        ...
        this.router.get(
            `${this.basePath}/getCfdiListingByAgency/:idEmpresa`,
...
// Envio de Correo LBM*
    ...
    private insertCotizacion(request: express.Request, response: express.Response) {
        ...
        cotizacionBussines.insertCotizacion(data).then(
            (res) => {
